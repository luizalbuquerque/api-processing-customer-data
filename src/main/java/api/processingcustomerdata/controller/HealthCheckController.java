...
public class HealthCheckController {
    ...
    @RequestMapping(value = "/api-processing-customer-data", method = RequestMethod.GET, produces = { "application/json"})
    ...
    public ResponseEntity<String> HealthCheck() {
        return new ResponseEntity<>("I'm alive - Processing Customer Data!", HttpStatus.OK);
    }
